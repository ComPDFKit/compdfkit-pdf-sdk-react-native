...
export const EXAMPLE_ROUTES = {
  ...
  annotationSelectionObservation: 'CPDFAnnotationSelectionObservationExample',
  annotationAppearance: 'CPDFAnnotationAppearanceExample',
  annotationReply: 'CPDFAnnotationReplyExample',
  ...
  securityWatermarkOperations: 'CPDFWatermarkOperationsExample',
  ...
  contentExtractionPageText: 'CPDFPageTextExtractionExample',
  contentExtractionImages: 'CPDFImageExtractionExample',
  ...
  contentEditorSelectionObservation: 'CPDFEditorSelectionObservationExample',
  ...
  formList: 'CPDFListFormFieldsExample',
  formCustomCreation: 'CPDFCustomFormCreationExample',
  formInterceptWidgetAction: 'CPDFInterceptWidgetActionExample',
  formCreationMode: 'CPDFApiFormCreationModeExample',
  formFieldSelectionObservation: 'CPDFFieldSelectionObservationExample',
