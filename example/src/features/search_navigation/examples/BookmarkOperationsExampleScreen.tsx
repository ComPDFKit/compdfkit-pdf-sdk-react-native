...
export default function BookmarkOperationsExampleScreen() {
  const [visible, setVisible] = useState(false);

  return (
    <SearchNavigationExampleScaffold
      title="Bookmark Operations"
      subtitle="Open the bookmark panel to add, edit, delete, and jump to bookmarks."
      actions={[
        {
          key: 'open-bookmark-panel',
