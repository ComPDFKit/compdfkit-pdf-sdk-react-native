...
type CustomContextMenuRoute = RouteProp<
  AppStackParamList,
...
const CPDFCustomContextMenuExampleScreen = () => {
  ...
  const route = useRoute<CustomContextMenuRoute>();
  ...
  const handleAnnotationOperation = async (identifier: string, event: any) => {
    ...
    switch (identifier) {
      ...
      case "custom_event_get_sound_annotation":
        Logger.log("Sound annotation:", annotation);
  ...
  const handleEditAreaOperation = (identifier: string, event: any) => {
    ...
    switch (identifier) {
      ...
      case "custom_get_image":
        ...
        Logger.log(JSON.stringify(editImageArea, null, 2));
        break;
    }
  };
  ...
  const handleCustomContextMenuItemTapped = async (
    ...
    Logger.log("Custom menu item tapped:", identifier, event);
    ...
    Logger.log(`Unknown identifier: ${identifier}`);
  };
