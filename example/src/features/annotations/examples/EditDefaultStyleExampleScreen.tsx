...
type EditDefaultStyleRoute = RouteProp<
  AppStackParamList,
  'CPDFEditDefaultStyleExample'
>;

export default function EditDefaultStyleExampleScreen() {
  const navigation = useNavigation();
  const route = useRoute<EditDefaultStyleRoute>();
  ...
  return (
    <AnnotationExampleScaffold
      ...
      subtitle="Read and overwrite the default annotation style payload used for new annotations."
      document={document}
      readerRef={readerRef}
      ...
      actions={annotationExampleScreenActions.defaultStyleExample}
