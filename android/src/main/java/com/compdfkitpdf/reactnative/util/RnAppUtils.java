...
/**
 * Provides small shared helpers used across the Android React Native bridge layer.
 */
public class RnAppUtils {


  /**
   * Converts the input value to hex color.
   */
  ...
  /**
   * Converts the input value to times.
   */
  ...
  /**
   * Returns int array to writable array.
   */
  ...
  /**
   * Returns the default filed name.
   */
