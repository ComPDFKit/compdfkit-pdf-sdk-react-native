...
/**
 * Provides enum conversion helpers between native values and React Native-friendly strings.
 */
public class RnEnumConverter {


    /**
     * Returns stamp shape to string.
     */
    ...
    /**
     * Returns string to standard stamp.
     */
    ...
    /**
     * Returns standard stamp to string.
     */
    ...
    /**
     * Returns stamp type to string.
     */
    public static String stampTypeToString(StampType stampType) {
        switch (stampType) {
            case STANDARD_STAMP:
                return "standard";
            case TEXT_STAMP:
    ...
    /**
     * Returns bord effect type to string.
     */
    ...
    /**
     * Returns string to bord effect type.
     */
    ...
    /**
     * Returns free text alignment to string.
     */
    ...
    /**
     * Returns string to free text alignment.
     */
    ...
    /**
     * Returns text alignment to string.
     */
    ...
    /**
     * Returns string to text alignment.
     */
    ...
    /**
     * Parses family and style from ps name.
     */
    ...
    /**
     * Returns string to cpdf annot type.
     */
    ...
    /**
     * Returns strong to annotation type.
     */
    ...
    /**
     * Returns edit align type to string.
     */
    ...
    /**
     * Returns string to edit align type.
     */
