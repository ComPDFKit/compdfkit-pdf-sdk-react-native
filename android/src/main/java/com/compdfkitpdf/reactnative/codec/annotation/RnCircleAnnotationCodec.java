...
/**
 * Maps circle annotation annotation data between native objects and React Native maps.
 */
public class RnCircleAnnotationCodec extends RnBaseAnnotationCodec {
  ...
  public void covert(CPDFAnnotation annotation, WritableMap map) {
    ...
    map.putString("borderColor", RnAppUtils.toHexColor(circleAnnotation.getBorderColor()));
    map.putInt("borderAlpha", circleAnnotation.getBorderAlpha());
    map.putString("fillColor", RnAppUtils.toHexColor(circleAnnotation.getFillColor()));
  ...
  public void updateAnnotation(CPDFAnnotation annotation, ReadableMap annotMap) {
    ...
    CPDFBorderEffectType cpdfBorderEffectType = RnEnumConverter.stringToBordEffectType(
      bordEffectType);
