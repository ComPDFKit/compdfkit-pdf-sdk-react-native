...
/**
 * Maps combo box widget data between native objects and React Native maps.
 */
public class RnComboBoxWidgetCodec extends RnBaseWidgetCodec {
  ...
  public void covert(CPDFWidget widget, WritableMap map) {
    ...
    map.putString("fontColor", RnAppUtils.toHexColor(comboBoxWidget.getFontColor()));
  ...
  public CPDFWidget addWidget(CPDFDocument document, ReadableMap widgetMap) {
    ...
    if (widget.isValid()) {
      ...
      if (TextUtils.isEmpty(title)){
        widget.setFieldName(RnAppUtils.getDefaultFiledName("Combox Choice_"));
      } else {
