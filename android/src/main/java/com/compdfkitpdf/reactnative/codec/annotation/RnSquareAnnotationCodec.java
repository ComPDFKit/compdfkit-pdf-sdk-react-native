...
/**
 * Maps square annotation annotation data between native objects and React Native maps.
 */
public class RnSquareAnnotationCodec extends RnBaseAnnotationCodec{
  ...
  public void covert(CPDFAnnotation annotation, WritableMap map) {
    ...
    map.putString("borderColor", RnAppUtils.toHexColor(squareAnnotation.getBorderColor()));
    map.putInt("borderAlpha", squareAnnotation.getBorderAlpha());
    map.putString("fillColor", RnAppUtils.toHexColor(squareAnnotation.getFillColor()));
  ...
  public void updateAnnotation(CPDFAnnotation annotation, ReadableMap annotMap) {
    ...
    CPDFBorderEffectType cpdfBorderEffectType = RnEnumConverter.stringToBordEffectType(bordEffectType);
